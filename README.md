...
### CPU
* **Frequency capping** – Uses [`cpupower`](https://man7.org/linux/man-pages/man1/cpupower.1.html) to temporarily set the CPU’s maximum clock (`-u`) and minimum clock (`-d`) before launching a client.  
