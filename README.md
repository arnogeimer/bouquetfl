...
![Toy example of capabilities: simulating hardware profiles and keeping track of federation process](https://github.com/arnogeimer/bouquetfl/blob/main/bouquetfl/timetable.pdf)
